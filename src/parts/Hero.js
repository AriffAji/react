...
import ImageHero_ from "assets/img/img-frame-hero.jpg";
...
export default function Hero(props) {
  function showMostPicked() {
    window.scrollTo({
      top: props.refMostPicked.offsetTop - 30,
      behavior: "smooth",
    });
  }
        ...
        <div className="row align-items-center">
          <div className="col-auto pr-5" style={{ width: 550 }}>
            ...
            <div className="row" style={{ marginTop: 80 }}>
              ...
              <div className="col-auto" style={{ marginRight: 35 }}>
                ...
                <h6 className="mt-3">
                  {numberFormat(props.data.treasures)} <span className="text-gray-500 font-weight-light">Traeasure</span>
                </h6>
              </div>
          ...
          <div className="col-6 pl-5">
            <div style={{ width: 520, height: 410 }}>
              ...
              <img src={ImageHero_} alt="Room with couches frame" className="img-fluid position-absolute" style={{ margin: "0 -15px 0 0px" }} />
            </div>
          </div>
        </div>
      </section>
